...
void DeviceDriverSet_Servo::setupServo(unsigned int Position_angle)
{
...
void DeviceDriverSet_Servo::testServo(void)
{
  for (;;)
  {
    myservo.attach(PIN_Servo_z);
...
void DeviceDriverSet_Servo::setServoPosition(unsigned int Position_angle)
{
  myservo.attach(PIN_Servo_z);
