...
void DeviceDriverSet_ULTRASONIC::setupUltrasonic(void)
{
  pinMode(ECHO_PIN, INPUT); //Ultrasonic module initialization
  pinMode(TRIG_PIN, OUTPUT);
}
void DeviceDriverSet_ULTRASONIC::getDistance(uint16_t *ULTRASONIC_Get /*out*/)
{
...
void DeviceDriverSet_ULTRASONIC::testUltrasonic(void)
{
